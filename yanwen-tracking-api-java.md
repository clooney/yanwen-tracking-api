Yanwen Tracking API - Java
================================
Use Java to track Yanwen shipments with Yanwen Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.yanwen;
    ...
    public class CreateYanwenTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("VR666608345YP");
                createTrackingParams.setCourierCode("yanwen");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateYanwenTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("UJ826304125YP");
                createTrackingParams1.setCourierCode("yanwen");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("UJ851722358YP");
                createTrackingParams2.setCourierCode("yanwen");
...
Get status of the shipment:
    ...
    public class GetYanwenTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("UJ826304125YP,UJ851722358YP");
                trackingParams.setCourierCode("yanwen");
...
Update a tracking by ID:
    ...
    public class UpdateYanwenTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "9bc1bd17696cfbad3c994a032f51ba78";
