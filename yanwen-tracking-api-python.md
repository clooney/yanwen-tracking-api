Yanwen Tracking API - Python
================================
Use Python to track Yanwen shipments with Yanwen Tracking API.
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    try:
      params = [
        {'tracking_number': 'UJ826304125YP', 'courier_code': 'yanwen'},
        {'tracking_number': 'UJ851722358YP', 'courier_code': 'yanwen'}
      ]
...
Get status of the shipment:
    ...
    try:
      ...
      # params = {'tracking_numbers': 'UJ851722358YP,VR666608345YP', 'courier_code': 'yanwen'}
