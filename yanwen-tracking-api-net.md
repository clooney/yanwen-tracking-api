Yanwen Tracking API - .Net
================================
Use .Net to track Yanwen shipments with Yanwen Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "VR666608345YP";
                  createTrackingParams.courierCode = "yanwen";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "UJ826304125YP,UJ851722358YP";
                  getTrackingResultsParams.courierCode = "yanwen";
